                ...
                <div className="py-10">
                    <div className="">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mt-10">
                            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition-all duration-300">
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition-all duration-300 col-span-2 sm:grid-cols-3">
